        ...
        <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
          <div>
            <h1 className="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight">
              {siteConfig.hero.header}{" "}
              <span className="text-green-600">
                {siteConfig.hero.headerHighlightText}
              </span>
            </h1>
            <p className="mt-3 text-lg text-gray-800">
              {siteConfig.hero.subheader}
            </p>

            {/* <!-- Buttons --> */}
            <div className="mt-7 grid gap-3 w-full sm:inline-flex">
              <a
                className="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-green-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none"
                href="#"
              >
                {siteConfig.hero.action.primary.text}
                <svg
              ...
              <a
                ...
                href="/contact"
              >
               {siteConfig.hero.action.secondary.text}
              </a>
            </div>
            {/* <!-- End Buttons --> */}
              ...
              <div className="py-5">
                ...
                <div className="mt-2">
                  ...
                  <span
                    ...
                    style={{ fontFamily: "Gerbera" }}
                  >
                    {siteConfig.hero.review.review1.by}
                  </span>
                  {/* <!-- End Star --> */}
                </div>
              </div>
              ...
              <div className="py-5">
                ...
                <div className="mt-2">
                  ...
                  <span
                    ...
                    style={{ fontFamily: "Gerbera" }}
                  >
                    {siteConfig.hero.review.review2.by}
                  </span>
                  {/* <!-- End Star --> */}
                </div>
              </div>
